    ...
    return (
        <div>
            ...
            <div className="d-flex">
                ...
                {
                    item.length === 0 ? <div style={{ backgroundColor: '#d6ffff', height: '800px' }} className="col-md-10 pt-4 d-flex justify-content-center"><h2 className="text-primary">Loading...</h2></div> : <div style={{ backgroundColor: '#d6ffff', height: '100%', minHeight: '800px' }} className="col-md-10 pt-4 d-flex justify-content-center">
                        <div className="">
